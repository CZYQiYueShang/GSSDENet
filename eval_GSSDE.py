...
parser.add_argument('--ckpt_name', type=str, default='ResNet101-200')
...
def main():
    ...
    eval_GSS.get_eval_metric(gt_mask_set, predict_mask_set, args.class_num, args.beta_square)
...
if __name__ == '__main__':
    ...
    '''
    GSSDENet
    resnet101     (IoU: 0.9569  PA: 0.9675  FB: 0.9776  MAE: 0.0325  BER: 5.6726)
                  (S1: 0.9039  S2: 0.9814  S3: 0.9956  REL: 0.1035  RMS: 0.3000  RMS_log: 0.1175  log_10: 0.0453)       
    GW-Depth
    resnet50      (IoU: 0.9276  PA: 0.9450  FB: 0.9651  MAE: 0.0550  BER: 8.6700)
                  (S1: 0.9020  S2: 0.9910  S3: 0.9980  REL: 0.0974  RMS: 0.2793  RMS_log: 0.1115  log_10: 0.0422)
    CGSDNet-Depth
    convnext_base (IoU: 0.9528  PA: 0.9645  FB: 0.9766  MAE: 0.0355  BER: 5.9431)
                  (S1: 0.8936  S2: 0.9843  S3: 0.9970  REL: 0.1089  RMS: 0.3082  RMS_log: 0.1221  log_10: 0.0474)
    '''
